...
from main.constants import APP_HOST, APP_PORT
from main.pipeline.prediction_pipeline import VehicleData, VehicleDataClassifier
from main.pipeline.training_pipeline import TrainPipeline
